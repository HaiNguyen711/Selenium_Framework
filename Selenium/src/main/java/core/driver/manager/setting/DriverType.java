...
public enum DriverType {
	 ...
	 *         to one of those constanted types it will return that driver type
	...
	public static DriverType fromString(String type) throws Exception {
		...
		throw new Exception(String.format("Driver type '%s' is not supported. Please use supported driver types: %s",
				type, Arrays.toString(DriverType.values())));
	}
}
