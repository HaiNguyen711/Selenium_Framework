package core.driver.manager.setting;
...
public class DriverProperty {
	 ...
	 *
	 * @param driverType - constanted driver type of browser: Chrome, firefox,
	 *                   Safari, Edge
	 */
	 ...
	 * Set user preference
	 *
	 * @param userProfilePreference - a map of string and object user profile
	 *                              preference
	 */
	 ...
	 * Set time out for page
	 *
	 * @param pageTimeOut - if user put a string of time out. This will check if
	 *                    that string is numeric then it will parse to int type
	 */
	 ...
	 *
	 * @param elementTimeOut - int timeout in seconds
	 */
	 ...
	 * Set time out for element
	 *
	 * @param elementTimeOut - if user put a string of time out. This will check if
	 *                    that string is numeric then it will parse to int type
	 */
